...
class LatestPost extends WP_Widget{
    public function __construct(){
        parent:: __construct(
            'latestpost',
            __('Latest Post','balitac'),
            array('description'=>__('This is show balita latest post in widgets','balitac'))
        );
    }

    public function form( $instance ) {
        $title = isset($instance['title']) ? $instance['title'] : __('Latest Post','balitac');
